...
//Initialisation du plateau. Taille modulable en changeant boardXBoxes/boardYBoxes
void Board::init() {
	Piece::init();
	boardXBoxes = 8;
	boardYBoxes = 8;
	//Permet de moduler la taille de la fenêtre et de l'étendre
...
//Change l'affichage d'un pion si il est promu
...
//Afficher la texture de la pièce déplacée
...
//Couleurs des cases : si les cases modulo de 2 =0 alors BLANC, sinon NOIR
...
//Affichage des textures des pièces sur le plateau
